...
1. `eval/run_eval.py` → one output: baseline F1, LLM F1, OSHA-set LLM F1, severity MAE. No human-ceiling line — see Evaluation: we have no independent agreement number to put in one.
